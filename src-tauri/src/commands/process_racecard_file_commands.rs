...
pub async fn process_racecard_file<'a>(path: String) -> Result<Racecard, String> {
    ...
    for line in &lines {
        ...
        let mut horse = Horse {
            ...
            key_trainer_stat_category_1_roi: line[SF_KEY_TRAINER_STAT_CATEGORY_1_TWO_DOLLAR_ROI].parse::<f64>().ok(),
            ...
            key_trainer_stat_category_2_roi: line[SF_KEY_TRAINER_STAT_CATEGORY_2_TWO_DOLLAR_ROI].parse::<f64>().ok(),
            ...
            key_trainer_stat_category_3_roi: line[SF_KEY_TRAINER_STAT_CATEGORY_3_TWO_DOLLAR_ROI].parse::<f64>().ok(),
            ...
            key_trainer_stat_category_4_roi: line[SF_KEY_TRAINER_STAT_CATEGORY_4_TWO_DOLLAR_ROI].parse::<f64>().ok(),
            ...
            key_trainer_stat_category_5_roi: line[SF_KEY_TRAINER_STAT_CATEGORY_5_TWO_DOLLAR_ROI].parse::<f64>().ok(),
            ...
            key_trainer_stat_category_6_roi: line[SF_KEY_TRAINER_STAT_CATEGORY_6_TWO_DOLLAR_ROI].parse::<f64>().ok(),
            ...
            trainer_jockey_combination_starts_meet: line[SF_TRAINER_JOCKEY_COMBO_STARTS_MEET].parse::<u32>().ok(),
            trainer_jockey_combination_wins_meet: line[SF_TRAINER_JOCKEY_COMBO_WINS_MEET].parse::<u32>().ok(),
            trainer_jockey_combination_places_meet: line[SF_TRAINER_JOCKEY_COMBO_PLACES_MEET].parse::<u32>().ok(),
            trainer_jockey_combination_shows_meet: line[SF_TRAINER_JOCKEY_COMBO_SHOWS_MEET].parse::<u32>().ok(),
            trainer_jockey_combination_roi_meet: line[SF_TRAINER_JOCKEY_COMBO_ROI_MEET].parse::<f64>().ok(),
        ...
        for j in 0..10 {
            let pp = PastPerformance { 
                ...
                claimed_from_and_trainer_switches_1: line[SF_PP_CLAIMED_AND_TRAINER_SWITCHES_1 + j].clone(),
                claimed_from_and_trainer_switches_2: line[SF_PP_CLAIMED_AND_TRAINER_SWITCHES_2 + j].clone(),
                claimed_from_and_trainer_switches_3: line[SF_PP_CLAIMED_AND_TRAINER_SWITCHES_3 + j].clone(),
                claimed_from_and_trainer_switches_4: line[SF_PP_CLAIMED_AND_TRAINER_SWITCHES_4 + j].clone(),
                claimed_from_and_trainer_switches_5: line[SF_PP_CLAIMED_AND_TRAINER_SWITCHES_5 + j].clone(),
                claimed_from_and_trainer_switches_6: line[SF_PP_CLAIMED_AND_TRAINER_SWITCHES_6 + j].clone(),
